...
@pytest.fixture
def example_asset_price_plan_stripe_subscription_object(
    example_stripe_customer_has_default_payment_method_object,
):
    current_day = datetime.datetime.now().day
    if current_day >= 5:
        billing_cycle_anchor = int(
            (datetime.datetime.now() + relativedelta(months=1, day=5)).timestamp()
        )
    else:
        billing_cycle_anchor = int(
    ...
    example_subscription = {
        ...
        "created": 1644592892,
        "current_period_end": 9999999999,
        "current_period_start": 1644592892,
        "customer": example_stripe_customer_has_default_payment_method_object['id'],
        "days_until_due": None,
        "default_payment_method": None,
        "default_source": None,
        ...
        "discount": None,
        "ended_at": None,
        "id": "sub_1KS0wCGAiB8oTF44KGQK4Kfr",
        "items": {
            "data": [
                {
                    "billing_thresholds": None,
                    "created": 1644592892,
                    "id": "si_L8HVzvw8oFBvfw",
                    "metadata": {},
                    "object": "subscription_item",
                    "plan": {
                        "active": True,
                        ...
                        "created": 1644510243,
                        "currency": "usd",
                        "id": "price_1KRfR9GAiB8oTF44cjmBta5j",
                        "interval": "month",
                        "interval_count": 1,
                        "livemode": False,
                        "metadata": {},
                    ...
                    "subscription": "sub_1KS0wCGAiB8oTF44KGQK4Kfr",
                    "tax_rates": [],
                }
            ],
            "has_more": False,
            "object": "list",
            "total_count": 1,
            "url": "/v1/subscription_items?subscription=sub_1KS0wCGAiB8oTF44KGQK4Kfr",
        },
        "latest_invoice": {
            "account_country": "US",
            ...
            "ending_balance": 0,
            "footer": None,
            "hosted_invoice_url": "https://invoice.stripe.com/i/acct_1JzKjMGAiB8oTF44/test_YWNjdF8xSnpLak1HQWlCOG9URjQ0LF9MOEhWVW9rRXlReGRJaGFlMDB5MGVEck1Vc2Rhbm1lLDM1MTMzNjkz0200DCBrPM40?s=ap",
            "id": "in_1KS0wCGAiB8oTF444Zl3vJpw",
            "invoice_pdf": "https://pay.stripe.com/invoice/acct_1JzKjMGAiB8oTF44/test_YWNjdF8xSnpLak1HQWlCOG9URjQ0LF9MOEhWVW9rRXlReGRJaGFlMDB5MGVEck1Vc2Rhbm1lLDM1MTMzNjkz0200DCBrPM40/pdf?s=ap",
            ...
            "lines": {
                "data": [
                    {
                        "amount": 0,
                        "currency": "usd",
                        "description": "0 \u00d7 codemesh product (at $0.00 / month)",
                        "discount_amounts": [],
                        "discountable": True,
                        "discounts": [],
                        "id": "il_1KS0wCGAiB8oTF44oenKcOHa",
                        "livemode": False,
                        "metadata": {},
                        "object": "line_item",
                        "period": {"end": 1646493441, "start": 1644592892},
                        "plan": {
                            "active": True,
                            "aggregate_usage": "last_during_period",
                            "amount": None,
                        ...
                        "quantity": 0,
                        "subscription": "sub_1KS0wCGAiB8oTF44KGQK4Kfr",
                        "subscription_item": "si_L8HVzvw8oFBvfw",
                        "tax_amounts": [],
                        "tax_rates": [],
                        "type": "subscription",
                    }
                ...
                "object": "list",
                "total_count": 1,
                "url": "/v1/invoices/in_1KS0wCGAiB8oTF444Zl3vJpw/lines",
            },
            "livemode": False,
            "metadata": {},
            "next_payment_attempt": None,
            "number": "D4A1DA22-0057",
            "object": "invoice",
            "on_behalf_of": None,
            "paid": True,
            ...
            "period_end": 1644592892,
            "period_start": 1644592892,
...
@pytest.fixture
def example_stripe_subscription_pause_object(
    example_stripe_price_create_event,
    example_stripe_product_create_event,
    example_stripe_customer_has_default_payment_method_object,
):
    example_solution = {
        "application_fee_percent": None,
        "automatic_tax": {"enabled": False},
        "billing_cycle_anchor": 1644033159,
        "billing_thresholds": None,
        "cancel_at": None,
        "cancel_at_period_end": False,
        "canceled_at": None,
        "collection_method": "charge_automatically",
        "created": 1644033159,
        "current_period_end": 1644205959,
        "current_period_start": 1644119559,
        "customer": example_stripe_customer_has_default_payment_method_object['id'],
        "days_until_due": None,
        "default_payment_method": None,
        "default_source": None,
        ...
        "latest_invoice": "in_1KOuwWGAiB8oTF44osF2bkWn",
        "livemode": False,
        "metadata": {},
        "next_pending_invoice_item_invoice": None,
        "object": "subscription",
        "pause_collection": {"behavior": "void", "resumes_at": None},
        "payment_settings": {
            "payment_method_options": None,
            "payment_method_types": None,
        },
...
@pytest.fixture
def example_stripe_subscription_resume_object(
    example_stripe_price_create_event,
    example_stripe_product_create_event,
    example_stripe_customer_has_default_payment_method_object,
):
    example_solution = {
        ...
        "latest_invoice": "in_1KQ1ykGAiB8oTF442KYH0Ew1",
        "livemode": False,
        "metadata": {},
        "next_pending_invoice_item_invoice": None,
        "object": "subscription",
