"""
Allows making software detail sitemap files from assets.
"""
...
"""
    ...
    # Write software detail pages' url to sitemap.
    for chunk_software in asset.objects.all().iterator(chunk_size=100):
        write_xml_str = """
    <url><loc>https://www.taggedweb.com/software/{}</loc><changefreq>weekly</changefreq><priority>0.7</priority><lastmod>{}</lastmod></url>""".format(
